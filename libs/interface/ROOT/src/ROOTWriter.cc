...
void ROOTWriter::processDIF(const Payload100& d)
{
...
void ROOTWriter::processFrame(const Payload100& d, const std::uint32_t& frameIndex)
{
...
void ROOTWriter::processPadInFrame(const Payload100& d, const std::uint32_t& frameIndex, const std::uint32_t& channelIndex)
{
