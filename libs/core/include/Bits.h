...
using bit32_t = std::uint32_t; /*<! type to represent 32bits words (3 bytes)*/
using bit64_t = std::uint64_t; /*<! type to represent 64bits words (4 bytes)*/
 ...
 * @return os
 *
 * \note This one is here and not in Formatters.h because this one is very important
 */
