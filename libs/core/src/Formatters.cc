...
{
  return fmt::format("{:#016x}",b);
}

std::string to_hex(const bit32_t& b)
{
  return fmt::format("{:#032x}",b);
}

std::string to_hex(const bit64_t& b)
{
  return fmt::format("{:#064x}",b);
}
